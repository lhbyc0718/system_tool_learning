...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{q13_check.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{q14_make.png}
    \caption{Make 增量构建验证}
    \label{fig:q14_make}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{q15_report.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{q16_build.png}
    \caption{make build 与 SHA-256}
    \label{fig:q16_build}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{q16_git.png}
    \caption{Git 提交记录}
    \label{fig:q16_git}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{git_commits_week4.png}
